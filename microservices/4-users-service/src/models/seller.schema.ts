import { ISellerDocument } from '@thejuggernaut01/jobberapp-shared';
...
export const SellerModel: Model<ISellerDocument> = mongoose.model<ISellerDocument>('Seller', sellerSchema);
